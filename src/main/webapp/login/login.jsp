    ...
    <script>
        $(function () {
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${path}/user/getImageCode?d="+new Date());
             });
            //表单验证 设置验证码规则
            $.extend($.validator.message,{
                required: "<sapn style='color:red'>这是必填字段</span>",
                minlength: $.validator.format("<sapn style='color:red'>最少要输入3个字符</span>")
            });
        });
    </script>
</head>
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/user/dl" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${pageContext.request.contextPath}/user/getImageCode">
                                <input minlength="3" istyle="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="enCode" id="form-code">
                            </div>
